...
<div class="bg-alveoles h-[1000px] z-0 bg-cover relative mx-4 mt-6">
        <div class="programme flex justify-center items-center max-w-[1000px]  gap-10 md:flex-col mx-auto bg-white p-4 shadow-xl rounded-3xl">
        ...
        <div class="content-programme w-1/2 flex flex-col gap-6">
          <h3 class="text-3xl font-bold font-dm-serif text-post-grey">Low Cost Latest Invented Interior Designing Ideas</h3>
          <p class="text-md font-jost-sans text-program-grey">Lorem ipsum dolor sit amet, adipiscing Aliquam eu sem vitae turpis dignissim maximus.posuere in.Contrary to popular belief.
          ...
          <p class="text-grey font-jost-sans">26 Décembre 2022</p>
          <h1 class="arrow text-xl text-grey inline-block font-bold bg-light-beige p-2 px-3 rounded-full">></h1>
        </div>
      </div>
    </div>
