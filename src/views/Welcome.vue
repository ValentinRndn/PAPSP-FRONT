...
<div class="bg-landing relative w-full h-screen bg-center z-10 mb-24 rounded-bl-[25%] bg-cover bg-no-repeat md:h-[50vh] md:mb-0">
  ...
  <aside class="flex items-center justify-center gap-5 mb-8 sm:hidden">
    ...
    <div class="header-content h-screen">
      ...
      <!-- Logo réseaux -->
      <div class="logo-reseaux flex justify-center items-center gap-4 absolute bottom-0 left-0 right-0 mb-8 md:gap-2">
  <a href="url_du_reseau_social_1">
    <svg xmlns="http://www.w3.org/2000/svg" class=" text-white hover:scale-110 duration-200 md:w-[40px]" width="50" height="50" viewBox="0 0 24 24">
      <path d="M13.397 20.997v-8.196h2.765l.411-3.209h-3.176V7.548c0-.926.258-1.56 1.587-1.56h1.684V3.127A22.336 22.336 0 0 0 14.201 3c-2.444 0-4.122 1.492-4.122 4.231v2.355H7.350v3.209h2.753v8.202h3.312z" fill="currentColor"/>
    </svg>
  </a>
  <a href="url_du_reseau_social_2">
    <svg xmlns="http://www.w3.org/2000/svg" class="text-white hover:scale-110 duration-200 md:w-[40px]" width="50" height="50" viewBox="0 0 24 24">
      <path fill="currentColor" d="M6.94 5a2 2 0 1 1-4-.002a2 2 0 0 1 4 .002M7 8.48H3V21h4zm6.50 0H9.34V21h3.94v-6.57c0-3.66 4.77-4 4.77 0V21H22v-7.93c0-6.17-7.06-5.94-8.72-2.91z"/>
    </svg>
  </a>
  ...
  <a href="url_du_reseau_social_4">
    <svg xmlns="http://www.w3.org/2000/svg" class="text-white hover:scale-110 duration-200 md:w-[40px]" width="50" height="50" viewBox="0 0 24 24"><path fill="currentColor" d="M7.8 2h8.4C19.4 2 22 4.6 22 7.8v8.4a5.8 5.8 0 0 1-5.8 5.8H7.8C4.6 22 2 19.4 2 16.2V7.8A5.8 5.8 0 0 1 7.8 2m-.2 2A3.6 3.6 0 0 0 4 7.6v8.8C4 18.39 5.61 20 7.6 20h8.8a3.6 3.6 0 0 0 3.6-3.6V7.6C20 5.61 18.39 4 16.4 4zm9.65 1.5a1.25 1.25 0 0 1 1.25 1.25A1.25 1.25 0 0 1 17.25 8A1.25 1.25 0 0 1 16 6.75a1.25 1.25 0 0 1 1.25-1.25M12 7a5 5 0 0 1 5 5a5 5 0 0 1-5 5a5 5 0 0 1-5-5a5 5 0 0 1 5-5m0 2a3 3 0 0 0-3 3a3 3 0 0 0 3 3a3 3 0 0 0 3-3a3 3 0 0 0-3-3"/></svg>
...
<div class="epsm-image">
  <img src="../assets/welcome/EPSM.png" alt="epsm" class="w-[150px] object-cover absolute bottom-0 right-20 md:w-[100px] md:right-5" />
</div>
  ...
  <div class="container-presentation flex flex-wrap justify-center items-center w-full gap-8 md:text-center">
    ...
    <div class="">
      <img src="../assets/stop.jpg" alt="stop" class="rounded-tr-[50%] w-[500px] h-[500px] object-cover md:mx-5" />
  ...
  <div class="flex flex-col items-center bg-purple rounded-2xl p-10 relative">
    ...
    <div class="numero flex gap-36 mb-10 mt-5 md:gap-10 md:text-4xl">
      ...
      <p class="flex-grow text-center text-lg md:text-sm">Pour les mineurs</p>
    </div>
    </div>
  ...
  <div class="flex  items-center justify-center -mt-8 font-helvetica  ">
   <div class="flex items-center bg-purple-fonce shadow-xl rounded-2xl gap-4 py-2 px-6 z-20 hover:scale-110 duration-200">
    ...
    <button class="text-white h-full font-bold text-xl md:text-lg md:p-4">NOUS CONTACTER</button>
  </div>
 </div>
...
<div class="relative top-56 w-full flex flex-col justify-center items-center md:top-25">
  ...
  <div class="cards flex gap-12 grow justify-center mt-6 md:flex-col ">
