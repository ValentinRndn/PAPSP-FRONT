    ...
    <div class="contact-form bg-white flex flex-col justify-center items-center gap-6 mt-6 ">
        <form class="flex flex-col gap-6">
            ...
            <div class="submit flex justify-end w-full">
                <button class="bg-purple-fonce text-white font-jost-sans font-semibold text-xl py-3 rounded-md px-6 transition-transform duration-300 hover:scale-105">Envoyer</button>
            </div>
        </form>   
    </div>
</div>
...
<!-- Réseaux sociaux -->
<div class="bg-alveoles h-[700px] z-0 bg-cover relative sm:w-full sm:h-full">
    <div class="mx-28"> <!-- Ajout de la classe mx-4 ici -->
        ...
        <div class="socials relative flex justify-center items-center mt-10 z-20 w-full gap-6">
            <div class="social-wrapper flex justify-center w-full gap-6"> <!-- Div wrapper ajoutée ici -->
